...
This project is indexed by GitNexus as **Pi-Chrome-Assistent** (2748 symbols, 5907 relationships, 237 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
